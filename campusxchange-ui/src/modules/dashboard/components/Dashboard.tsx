        ...
        <Container className="mt-4">
            <Row>
                <Col>
                    ...
                    <p>
                        Easily manage or add your items on CampusXchange. You
                        can review, accept or decline offers for your items
                        here. Don't forget to mark your item as sold after the
